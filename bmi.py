...
def calculate_bmi():
    try:
        ...
        result_label.configure(text="BMI is: {:.2f}".format(bmi))
    except ValueError:
...
calculate_button = customtkinter.CTkButton(app,command=calculate_bmi,font=font2,text_color='#fff',text='Calculate BMI0',fg_color='#06911f',hover_color='#06911f',bg_color='#000',cursor='hand2',corner_radius=5,width=200)
